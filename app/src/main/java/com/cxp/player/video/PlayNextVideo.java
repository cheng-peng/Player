 ...
 * 文 件 名: PlayNextVideo
 * 创 建 人: CXP
 * 创建日期: 2018-08-23 10:03
 * 描    述: 自动播放下一集
 * 修 改 人:
 * 修改时间：
 * 修改备注：
 */
public class PlayNextVideo extends StandardGSYVideoPlayer {
     ...
     */
    public PlayNextVideo(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public PlayNextVideo(Context context) {
        super(context);
    }

    public PlayNextVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        PlayNextVideo sf = (PlayNextVideo) from;
        PlayNextVideo st = (PlayNextVideo) to;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            PlayNextVideo nextVideo = (PlayNextVideo) gsyBaseVideoPlayer;
            GSYVideoModel gsyVideoModel = mUriList.get(mPlayPosition);
            if (!TextUtils.isEmpty(gsyVideoModel.getTitle())) {
                nextVideo.mTitleTextView.setText(gsyVideoModel.getTitle());
            }
        }
