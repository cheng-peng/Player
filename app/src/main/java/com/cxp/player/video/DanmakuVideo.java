...
import com.cxp.player.system.adapter.DanamakuAdapter;
import com.cxp.player.utils.BiliDanmukuParser;
 ...
 * 文 件 名: DanmakuVideo
 * 创 建 人: CXP
 * 创建日期: 2018-08-24 8:20
 * 描    述:
 * 修 改 人:
 * 修改时间：
 * 修改备注：
 */
public class DanmakuVideo extends StandardGSYVideoPlayer {
    ...
    public DanmakuVideo(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public DanmakuVideo(Context context) {
        super(context);
    }

    public DanmakuVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    public int getLayoutId() {
        return R.layout.video_danmaku;
    }
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ((DanmakuVideo)to).mDumakuFile = ((DanmakuVideo)from).mDumakuFile;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            DanmakuVideo gsyVideoPlayer = (DanmakuVideo) gsyBaseVideoPlayer;
            //对弹幕设置偏移记录
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            DanmakuVideo gsyDanmaVideoPlayer = (DanmakuVideo) gsyVideoPlayer;
    ...
    public void setDanmaKuStream(File is) {
        ...
        if(!getDanmakuView().isPrepared()) {
            onPrepareDanmaku((DanmakuVideo)getCurrentPlayer());
        }
    }
                ...
                public void prepared() {
                    if (getDanmakuView() != null) {
                        ...
                        if (getDanmakuStartSeekPosition() != -1) {
                            resolveDanmakuSeek(DanmakuVideo.this, getDanmakuStartSeekPosition());
     ...
     * 开始播放弹幕
     */
    private void onPrepareDanmaku(DanmakuVideo gsyVideoPlayer) {
     ...
     * 弹幕偏移
     */
    private void resolveDanmakuSeek(DanmakuVideo gsyVideoPlayer, long time) {
     ...
     * 释放弹幕控件
     */
    private void releaseDanmaku(DanmakuVideo DanmakuVideo) {
        if (DanmakuVideo != null && DanmakuVideo.getDanmakuView() != null) {
            Debuger.printfError("release Danmaku!");
            DanmakuVideo.getDanmakuView().release();
        }
    }
